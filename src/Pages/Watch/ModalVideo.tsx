...
export default function ModalVideo({ callBack, link, isShowModal }: ModalVideoProps) {
  ...
  function handlerClose(e: MouseEvent) {
    if (((e as any).target.id === "backdrop" && (e as any).target.tagName === "DIV") || (e as any).target.id === "button-close") {
      setIsShow(false);
      setTimeout(() => {
        if (callBack) {
          callBack(e);
